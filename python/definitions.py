...
properties = [
    ...
    ("min-height", ["mheight"], "rem", ["auto"]),
    ("min-width", ["mwidth"], "rem", ["auto"]),
    ("max-height", ["xheight","mxheight"], "rem", ["auto"]),
    ("max-width", ["xwidth","mxheight"], "rem", ["auto"]),

    ("margin-left", ["mleft","marleft"], "rem", ["auto"]),
    ("margin-right", ["mright","marright"], "rem", ["auto"]),
    ("margin-top", ["mtop","martop"], "rem", ["auto"]),
    ("margin-bottom", ["mbottom","marbottom"], "rem", ["auto"]),

    ("padding-left", ["pleft","padleft"], "rem", None),
    ("padding-right", ["pright","padright"], "rem", None),
    ("padding-top", ["ptop","padtop"], "rem", None),
    ("padding-bottom", ["pbottom","padbottom"], "rem", None),
    ...
    ("border-right", ["br"], None, None),
    ("border-left", ["bl"], None, None),
    ("border-top", ["bt"], None, None),
    ("border-bottom", ["bb"], None, None),

    ("border-width", ["bw"], "px", None),
    ("border-right-width", ["brw"], "px", None),
    ("border-left-width", ["blw"], "px", None),
    ("border-top-width", ["btw"], "px", None),
    ("border-bottom-width", ["bbw"], "px", None),
    ...
    ("grid-column-gap", ["gcg"], "rem", None),
    ("grid-row-gap", ["grg"], "rem", None),
